...
INSERT INTO `doingsdone`.`tasks` (`task_name`, `category_id`, `date_create`, `deadline`) VALUES ('Купить комп для кота', '4', '2019-04-23 16:07:27', '2019-04-23');
...
UPDATE `doingsdone`.`tasks` SET `status_complete`='1' WHERE  `id`=7;

-- Обновить название задачи по её идентификатору
UPDATE `doingsdone`.`tasks` SET `task_name`='Купить комп для кота и пса' WHERE  `id`=8;
